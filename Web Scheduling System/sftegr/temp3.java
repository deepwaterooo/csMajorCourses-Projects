...
public class SimpleTableDemo extends JPanel {
	...
	JComboBox LenOpt = new JComboBox(LengthOptions);
        
	comboPanel.add(comboLbl);  // Jlabel
	comboPanel.add(LenOpt);    // JCombobox
	...
	SubmitBut.addActionListener(new ActionListener()
		...
		{
		    //When the Submit button is pressed the setVisible value of the listPanel and comboPanel is switched from true to value or vice versa.

		    //		    table.setVisible(!table.isVisible());   //does not use listPanel anymore
	...
	//	guiFrame.add(listPanel, BorderLayout.CENTER);   the alternate showing panel
	guiFrame.add(SubmitBut,BorderLayout.SOUTH);
