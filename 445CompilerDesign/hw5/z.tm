...
* EXPRESSION STMT
 ...
 66:    LDA  4,-3(0) 	Load address of base of array h
 67:    SUB  3,4,3 	Compute offset of value 
 68:     LD  3,0(3) 	Load the value 
 69:     LD  4,-15(1) 	Restore index 
 70:    LDA  5,-3(0) 	Load address of base of array h
...
* EXPRESSION STMT
100:     ST  1,-14(1) 	Store old frame in ghost frame 
...
* EXPRESSION STMT
109:     ST  1,-14(1) 	Store old frame in ghost frame 
110:     LD  3,-3(1) 	Load variable a
...
* EXPRESSION STMT
* EXPRESSION STMT
118:     ST  1,-14(1) 	Store old frame in ghost frame 
...
134:     ST  3,-2(0) 	save size of array h
