...
381:     LD  3,-2(1) 	Load variable i
* EXPRESSION STMT
383:     LD  3,-2(1) 	Load variable i
384:     ST  3,-2(1) 	Store variable i
382:    JEQ  3,3(7) 	if: jmp to else 
* EXPRESSION STMT
386:     LD  3,-3(1) 	Load variable b
387:     ST  3,-3(1) 	Store variable b
385:    LDA  7,2(7) 	jmp to end 
* WHILE
388:    LDC  3,1(6) 	Load constant 
389:    JGT  3,1(7) 	Jump to while part 
* DO
* EXPRESSION STMT
391:     LD  3,-2(1) 	Load variable i
392:     ST  3,-2(1) 	Store variable i
393:    LDA  7,-4(7) 	go to beginning of loop 
390:    LDA  7,3(7) 	No more loop 
* end WHILE
* WHILE
394:     LD  3,-8(1) 	Load variable ba
395:    JGT  3,1(7) 	Jump to while part 
* DO
* EXPRESSION STMT
397:     LD  3,-2(1) 	Load variable i
398:     ST  3,-2(1) 	Store variable i
399:    LDA  7,-4(7) 	go to beginning of loop 
396:    LDA  7,3(7) 	No more loop 
* end WHILE
* WHILE
400:     LD  3,-5(1) 	Load variable ia
401:    JGT  3,1(7) 	Jump to while part 
* DO
* EXPRESSION STMT
403:     LD  3,-2(1) 	Load variable i
404:     ST  3,-2(1) 	Store variable i
405:    LDA  7,-4(7) 	go to beginning of loop 
402:    LDA  7,3(7) 	No more loop 
* end WHILE
* WHILE
406:     LD  3,-3(1) 	Load variable b
407:    JGT  3,1(7) 	Jump to while part 
* DO
* EXPRESSION STMT
409:     LD  3,-2(1) 	Load variable i
410:     ST  3,-2(1) 	Store variable i
411:    LDA  7,-4(7) 	go to beginning of loop 
408:    LDA  7,3(7) 	No more loop 
* end WHILE
* WHILE
412:     LD  3,-2(1) 	Load variable i
413:    JGT  3,1(7) 	Jump to while part 
* DO
* EXPRESSION STMT
415:     LD  3,-2(1) 	Load variable i
416:     ST  3,-2(1) 	Store variable i
417:    LDA  7,-4(7) 	go to beginning of loop 
414:    LDA  7,3(7) 	No more loop 
* end WHILE
...
* END function main
  0:    LDA  7,421(7) 	Jump to init 
* BEGIN Init
422:     LD  0,0(0) 	Set the global pointer 
423:    LDA  1,0(0) 	set first frame at end of globals 
424:     ST  1,0(1) 	store old fp (point to self) 
425:    LDA  3,1(7) 	Return address in ac 
426:    LDA  7,-397(7) 	Jump to main 
427:   HALT  0,0,0 	DONE! 
* END Init
