...
//  Special register defines for optional use in calling the routines below.
...
//  ... and updated to use variable argument lists like printf
void emitRO(char *op, int r, int s, int t, char *c, ...);
#define emitRO2(op, r, s, t, c, cc) emitRO(op, r, s, t, "%s %s", c, cc)
void emitRM(char *op, int r, int d, int s, char *c, ...);
#define emitRM2(op, t, d, s, c, cc) emitRO(op, t, d, s, "%s %s", c, cc);
void emitRMAbs(char *op, int r, int a, char *c, ...);
#define emitRMAbs2(op, r, a, c, cc) emitRMAbs(op, r, a, "%s %s", c, cc);
int emitSkip(int howMany);
void emitBackup(int loc);
void emitRestore(void);
void emitComment(char *c, ...);
#define emitComment2(c, cc) emitComment("%s %s", c, cc);
#endif
