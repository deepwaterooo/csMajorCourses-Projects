...
* EXPRESSION STMT
* END compound statement
173:    LDA  7,-22(7) 	go to beginning of loop 
157:    LDA  7,16(7) 	No more loop 
* ENDWHILE
* EXPRESSION STMT
174:     ST  1,-4(1) 	Store old frame in ghost frame 
175:    LDA  1,-4(1) 	Load address of new frame 
176:    LDA  3,1(7) 	Return address in ac 
177:    LDA  7,-153(7) 	CALL outnl
178:    LDA  3,0(2) 	Save the result in ac 
* EXPRESSION STMT
* END compound statement
179:    LDA  7,-36(7) 	go to beginning of loop 
149:    LDA  7,30(7) 	No more loop 
* ENDWHILE
* END compound statement
180:    LDA  7,-57(7) 	go to beginning of loop 
126:    LDA  7,54(7) 	No more loop 
* ENDWHILE
* END compound statement
* Add standard closing in case there is no return statement
