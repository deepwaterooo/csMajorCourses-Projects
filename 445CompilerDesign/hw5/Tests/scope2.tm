...
* EXPRESSION STMT
 ...
 38:     ST  3,-2(1) 	Store variable a
* EXPRESSION STMT
 39:    LDC  3,7(6) 	Load constant 
 40:     ST  3,-3(1) 	Store variable b
* EXPRESSION STMT
 41:    LDC  3,8(6) 	Load constant 
 42:     ST  3,-4(1) 	Store variable c
* EXPRESSION STMT
 43:    LDC  3,9(6) 	Load constant 
 44:     ST  3,-1(1) 	Store variable g
* EXPRESSION STMT
 45:    LDC  3,10(6) 	Load constant 
 46:     ST  3,-2(1) 	Store variable x
* EXPRESSION STMT
 47:     ST  1,-5(1) 	Store old frame in ghost frame 
...
* EXPRESSION STMT
 54:     ST  1,-5(1) 	Store old frame in ghost frame 
...
* EXPRESSION STMT
 61:     ST  1,-5(1) 	Store old frame in ghost frame 
...
* EXPRESSION STMT
 68:     ST  1,-5(1) 	Store old frame in ghost frame 
 69:     LD  3,-1(1) 	Load variable g
...
* EXPRESSION STMT
 75:     ST  1,-5(1) 	Store old frame in ghost frame 
...
* EXPRESSION STMT
 82:     ST  1,-5(1) 	Store old frame in ghost frame 
...
* EXPRESSION STMT
 87:     ST  1,-5(1) 	Store old frame in ghost frame 
...
* EXPRESSION STMT
 94:     ST  1,-5(1) 	Store old frame in ghost frame 
...
* EXPRESSION STMT
101:     ST  1,-5(1) 	Store old frame in ghost frame 
102:     LD  3,-1(1) 	Load variable g
...
* EXPRESSION STMT
108:     ST  1,-5(1) 	Store old frame in ghost frame 
...
* EXPRESSION STMT
115:     ST  1,-5(1) 	Store old frame in ghost frame 
...
121:     ST  3,-2(1) 	Store variable a
* EXPRESSION STMT
122:    LDC  3,12(6) 	Load constant 
123:     ST  3,-3(1) 	Store variable b
* EXPRESSION STMT
...
* END compound statement
* EXPRESSION STMT
128:     ST  1,-5(1) 	Store old frame in ghost frame 
...
* EXPRESSION STMT
135:     ST  1,-5(1) 	Store old frame in ghost frame 
...
* EXPRESSION STMT
142:     ST  1,-5(1) 	Store old frame in ghost frame 
143:     LD  3,-1(1) 	Load variable g
...
* EXPRESSION STMT
149:     ST  1,-5(1) 	Store old frame in ghost frame 
...
* EXPRESSION STMT
156:     ST  1,-5(1) 	Store old frame in ghost frame 
...
184:     ST  3,-6(1) 	Store variable a
* EXPRESSION STMT
185:    LDC  3,1(6) 	Load constant 
186:     ST  3,-1(1) 	Store variable g
* EXPRESSION STMT
187:     ST  1,-2(1) 	Store old frame in ghost frame 
* EXPRESSION STMT
188:     ST  1,-4(1) 	Store old frame in ghost frame 
189:    LDC  3,2(6) 	Load constant 
190:     ST  3,-6(1) 	Store parameter 
191:    LDA  1,-4(1) 	Load address of new frame 
...
* EXPRESSION STMT
200:     ST  1,-2(1) 	Store old frame in ghost frame 
201:     LD  3,-1(1) 	Load variable g
...
* EXPRESSION STMT
214:     ST  1,-2(1) 	Store old frame in ghost frame 
