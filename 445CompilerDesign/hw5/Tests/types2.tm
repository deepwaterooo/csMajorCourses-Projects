...
* DO
* EXPRESSION STMT
416:     LD  3,0(1) 	Load variable i
417:     ST  3,0(1) 	Store variable i
418:    LDA  7,-6(7) 	go to beginning of loop 
415:    LDA  7,3(7) 	No more loop 
* ENDWHILE
* WHILE
419:     LD  3,-5(1) 	Load variable ba
420:    JGT  3,1(7) 	Jump to while part 
* DO
* EXPRESSION STMT
422:     LD  3,0(1) 	Load variable i
423:     ST  3,0(1) 	Store variable i
424:    LDA  7,-6(7) 	go to beginning of loop 
421:    LDA  7,3(7) 	No more loop 
* ENDWHILE
* WHILE
425:     LD  3,-4(1) 	Load variable ia
426:    JGT  3,1(7) 	Jump to while part 
* DO
* EXPRESSION STMT
428:     LD  3,0(1) 	Load variable i
429:     ST  3,0(1) 	Store variable i
430:    LDA  7,-6(7) 	go to beginning of loop 
427:    LDA  7,3(7) 	No more loop 
* ENDWHILE
* WHILE
431:     LD  3,-2(1) 	Load variable b
432:    JGT  3,1(7) 	Jump to while part 
* DO
* EXPRESSION STMT
434:     LD  3,0(1) 	Load variable i
435:     ST  3,0(1) 	Store variable i
436:    LDA  7,-6(7) 	go to beginning of loop 
433:    LDA  7,3(7) 	No more loop 
* ENDWHILE
...
* END function main
  0:    LDA  7,440(7) 	Jump to init 
* BEGIN Init
441:     LD  0,0(0) 	Set the global pointer 
442:    LDA  1,0(0) 	set first frame at end of globals 
443:     ST  1,0(1) 	store old fp (point to self) 
444:    LDA  3,1(7) 	Return address in ac 
445:    LDA  7,-416(7) 	Jump to main 
446:   HALT  0,0,0 	DONE! 
* END Init
