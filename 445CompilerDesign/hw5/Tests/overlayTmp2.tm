...
* EXPRESSION STMT
 ...
 70:     ST  3,-4(1) 	Store variable y
* EXPRESSION STMT
 71:    LDC  3,666(6) 	Load constant 
 72:     ST  3,-3(1) 	Save left side 
* EXPRESSION STMT
 73:     ST  1,-4(1) 	Store old frame in ghost frame 
 74:     LD  3,-4(1) 	Load variable y
...
* EXPRESSION STMT
 83:     ST  1,-3(1) 	Store old frame in ghost frame 
 84:     LD  3,-4(1) 	Load variable y
...
105:    ADD  3,4,3 	Op + 
106:     ST  3,0(1) 	Store variable z
* EXPRESSION STMT
107:     ST  1,-3(1) 	Store old frame in ghost frame 
108:     LD  3,0(1) 	Load variable z
...
* EXPRESSION STMT
114:     ST  1,-3(1) 	Store old frame in ghost frame 
