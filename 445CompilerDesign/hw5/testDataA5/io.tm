...
110:     LD  4,-6(1) 	Load left into ac1 
111:    MUL  3,4,3 	Op * 
112:     ST  3,-6(1) 	Save left side 
113:    LDC  3,6(6) 	Load constant 
114:     ST  3,-7(1) 	Save left side 
...
157:     ST  3,-3(1) 	Store variable b
* EXPRESSION STMT
158:     ST  1,-4(1) 	Store old fp in ghost frame 
159:     LD  3,-3(1) 	Load variable b
...
171:     ST  1,-6(1) 	Store old fp in ghost frame 
...
176:     ST  3,-6(1) 	Save left side 
177:     ST  1,-7(1) 	Store old fp in ghost frame 
178:    LDA  1,-7(1) 	Load address of new frame 
179:    LDA  3,1(7) 	Return address in ac 
180:    LDA  7,-180(7) 	CALL input
181:    LDA  3,0(2) 	Save the result in ac 
182:     LD  4,-6(1) 	Load left into ac1 
183:    MUL  3,4,3 	Op * 
184:     ST  3,-6(1) 	Store parameter 
185:    LDA  1,-4(1) 	Load address of new frame 
186:    LDA  3,1(7) 	Return address in ac 
187:    LDA  7,-182(7) 	CALL output
188:    LDA  3,0(2) 	Save the result in ac 
* EXPRESSION STMT
189:     ST  1,-4(1) 	Store old fp in ghost frame 
...
195:     ST  1,-6(1) 	Store old fp in ghost frame 
...
201:     ST  1,-7(1) 	Store old fp in ghost frame 
202:    LDA  1,-7(1) 	Load address of new frame 
203:    LDA  3,1(7) 	Return address in ac 
204:    LDA  7,-192(7) 	CALL inputb
205:    LDA  3,0(2) 	Save the result in ac 
206:     LD  4,-6(1) 	Load left into ac1 
...
* EXPRESSION STMT
214:     ST  1,-4(1) 	Store old fp in ghost frame 
215:    LDA  1,-4(1) 	Load address of new frame 
