...
// The record in the bucket lists for each variable, 
// including name, assigned memory location, 
// and the list of line numbers in which it appears in the source code  
...
// listing of the symbol table contents to the listing file  
